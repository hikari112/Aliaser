...
The software and associated documentation files (the "Software") are hereby licensed to you on an "AS-IS" basis, without warranty of any kind, either expressed or implied, subject to the terms set forth in this Licensing Agreement and the MIT License.

... [Include the rest of the Licensing Agreement sections here]
